...
def _encrypt_authorization(text: str) -> str:
    """复刻第二课堂前端的 CryptoJS AES-ECB Authorization 签名。"""
    key = "xiangfubeitu2025".encode("utf-8")
...
def _source_api_get(driver, url: str, params: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        # performance 记录里经常带着旧的 ?params={size:10}，必须剥掉。
        ...
        request_url = f"{target_url}{separator}{query}"
